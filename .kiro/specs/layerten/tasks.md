...
- [ ] 4. Implement service layer for ranked lists
  - [~] 4.1 Create SlugService for slug generation
...
- [ ] 5. Implement service layer for blog posts
  - [~] 5.1 Create BlogPostService
...
- [ ] 6. Implement media service and file storage
  - [~] 6.1 Create MediaService
...
- [ ] 8. Implement Spring Security configuration
  - [~] 8.1 Create SecurityConfig
...
- [~] 9. Checkpoint - Ensure backend services and security work
...
- [ ] 10. Implement public API controllers
  - [~] 10.1 Create PublicListController
  ...
  - [~] 10.2 Create PublicPostController
...
- [ ] 11. Implement admin API controllers
  - [~] 11.1 Create AdminListController
  ...
  - [~] 11.2 Create AdminPostController
...
- [ ] 12. Implement global exception handling
  - [~] 12.1 Create @ControllerAdvice for exception handling
...
- [ ] 13. Implement validation logic
  - [~] 13.1 Add Bean Validation annotations to request DTOs
...
- [ ] 14. Implement search and filtering properties
...
- [ ] 15. Implement relationship properties
...
- [ ] 17. Set up frontend project structure
  ...
  - [~] 17.2 Create API client service
  ...
  - [~] 17.3 Set up TailwindCSS and global styles
